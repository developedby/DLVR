...
cv2.createTrackbar('h min', 'params', 0, 180, lambda: None)
cv2.createTrackbar('h max', 'params', 0, 180, lambda: None)
cv2.createTrackbar('l min', 'params', 0, 255, lambda: None)
cv2.createTrackbar('l max', 'params', 0, 255, lambda: None)
cv2.createTrackbar('s min', 'params', 0, 255, lambda: None)
cv2.createTrackbar('s max', 'params', 0, 255, lambda: None)
