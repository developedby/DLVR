...
city = {
    1: {2: (Direction.EAST, 0.72)},
    2: {1: (Direction.WEST, 0.72), 3: (Direction.EAST, 0.26), 10: (Direction.SOUTH, 0.77)},
    3: {2: (Direction.WEST, 0.26), 4: (Direction.EAST, 0.71)},
    4: {3: (Direction.WEST, 0.71)},
    5: {3: (Direction.NORTH, 0.25), 6: (Direction.EAST, 0.46)},
    6: {7: (Direction.EAST, 0.25), 8: (Direction.SOUTH, 0.26)},
    7: {6: (Direction.WEST, 0.25)},
    8: {9: (Direction.EAST, 0.25), 12: (Direction.SOUTH, 0.26)},
    9: {8: (Direction.WEST, 0.25)},
    10: {24: (Direction.WEST, 0.31), 16: (Direction.SOUTH, 0.52)},
    11: {10: (Direction.WEST, 0.26), 5: (Direction.NORTH, 0.52)},
    12: {11: (Direction.WEST, 0.46), 13: (Direction.EAST, 0.25)},
    13: {12: (Direction.WEST, 0.25)},
    14: {12: (Direction.NORTH, 0.26), 15: (Direction.EAST, 0.25)},
    15: {14: (Direction.WEST, 0.25)},
    16: {21: (Direction.SOUTH, 0.39), 17: (Direction.EAST, 0.26)},
    17: {11: (Direction.NORTH, 0.52), 18: (Direction.EAST, 0.46)},
    18: {14: (Direction.NORTH, 0.26), 19: (Direction.EAST, 0.25)},
    19: {18: (Direction.WEST, 0.25)},
    20: {21: (Direction.EAST, 0.72)},
    21: {20: (Direction.WEST, 0.72), 22: (Direction.EAST, 0.26)},
    22: {17: (Direction.NORTH, 0.39), 21: (Direction.WEST, 0.26), 23: (Direction.EAST, 0.72)},
    23: {22: (Direction.WEST, 0.72)},
    24: {25: (Direction.WEST, 0.34)},
    25: {26: (Direction.WEST, 0.21)},
    26: {30: (Direction.SOUTH, 0.54)},
    27: {28: (Direction.EAST, 0.20)},
    28: {29: (Direction.EAST, 0.25)},
    29: {16: (Direction.EAST, 0.31)},
    30: {27: (Direction.SOUTH, 0.36), 31: (Direction.EAST, 0.24)},
    31: {30: (Direction.WEST, 0.24)},
}
...
def path_to_directions(graph, path, orientation, turn_discount):
    ret = []
